...
// ==========================================================================
// PHASE — niveau de progression vers l'objectif
// ==========================================================================

/**
 * Phase 1 > 92 kg (recomposition)
 * Phase 2 : 85-92 kg (affinage)
 * Phase 3 : < 85 kg (marathon)
 */
export function computePhase(poids) {
  if (!poids) return 1;
  if (poids > 92) return 1;
  if (poids >= 85) return 2;
  return 3;
}
