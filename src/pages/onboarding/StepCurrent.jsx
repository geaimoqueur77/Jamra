...
const ACTIVITY_OPTIONS = [
  { key: 'sedentaire', title: 'Sédentaire',  description: "Bureau, peu d'activité physique" },
  { key: 'leger',      title: 'Léger',       description: 'Marche quotidienne, 1-2 séances/sem' },
  { key: 'modere',     title: 'Modéré',      description: '3-4 séances/sem' },
  { key: 'intense',    title: 'Intense',     description: '5+ séances/sem' },
];
